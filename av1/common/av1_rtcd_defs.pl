...
if (aom_config("CONFIG_PVQ") eq "yes") {
  add_proto qw/float pvq_search_rdo_float/, "const int16_t *xcoeff, int n, int k, int *ypulse, float g2, float pvq_norm_lambda, int prev_k";
  specialize qw/pvq_search_rdo_float sse4_1/;
}
