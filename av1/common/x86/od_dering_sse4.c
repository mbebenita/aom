...
static INLINE __m128i fold_mul_and_sum(__m128i partiala, __m128i partialb,
  ...
  /* Reverse partial B. */
  partialb =
      _mm_shuffle_epi8(partialb, _mm_set_epi8(15, 14, 1, 0, 3, 2, 5, 4, 7, 6, 9,
                                              8, 11, 10, 13, 12));
...
/* Horizontal sum of 8x16-bit unsigned values. This function assumes the values
 * are 12 bits or less. */
int32_t hsum_epi16(__m128i a) {
  a = _mm_hadd_epi16(a, a);
  a = _mm_hadd_epi16(a, a);
  a = _mm_hadd_epi16(a, a);
  return _mm_cvtsi128_si32(a) & 0xffff;
}
...
__m128i od_cmplt_abs_epi16(__m128i in, __m128i threshold) {
